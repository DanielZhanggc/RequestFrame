...
import static com.yitong.requestframe.rxjava.DefaultObserver.ExceptionReason.BAD_NETWORK;
...
public abstract class DefaultObserver<T> implements Observer<T> {
    ...
    protected DefaultObserver(Context context) {
    ...
    public void onNext(@NonNull T t) {
        if ("0".equals(((BaseBean) t).getSTATUS())) {
            onSuccess(t);
        } else {
            onFail((BaseBean) t);
        }
